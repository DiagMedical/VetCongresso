    ...
    <div className="space-y-6">
      ...
      >
        <div className="space-y-3">
          <div className="rounded-xl border border-border/70 bg-background/60 p-3 font-mono text-xs leading-6">
            ...
            <div key={chave}>
              ...
              <div className="flex flex-col gap-2 md:flex-row">
                ...
                <button
                  ...
                  className="rounded-xl bg-primary px-3 py-2 text-xs text-primary-foreground transition-all hover:brightness-110 disabled:opacity-50 md:whitespace-nowrap"
                >
        ...
        <div className="space-y-3">
          <div className="flex flex-col gap-2 md:flex-row">
            ...
            <button
              ...
              className="flex items-center gap-1 rounded-xl bg-primary px-4 py-2 text-sm text-primary-foreground transition-all hover:brightness-110 disabled:opacity-50 md:whitespace-nowrap"
            >
      ...
      >
        <div className="flex justify-end pb-3">
          <button
            onClick={load}
            className="flex items-center gap-1 rounded-md px-2 py-1 text-xs text-muted transition-colors hover:text-foreground"
          >
