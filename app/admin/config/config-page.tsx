    ...
    <div className="space-y-6">
      ...
      >
        <div className="space-y-3">
          <div className="rounded-xl border border-border/70 bg-background/60 p-4 font-mono text-xs leading-6">
      ...
      <div className="flex justify-end">
        <button
          onClick={load}
          className="flex items-center gap-1 rounded-md px-3 py-1.5 text-xs text-muted transition-colors hover:text-foreground"
        >
